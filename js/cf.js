  ...
  $.fn.featureCarousel = function (options) {
    ...
    var animateFeature = function($feature, direction)
    {
      ...
      if (newPosition == 1) {
        ...
        new_left = 334;//(pluginData.containerWidth / 2) - (pluginData.largeFeatureWidth / 2) - (pluginData.borderWidth / 2);
        new_fade = 1.0;
      } else {
        new_width = pluginData.smallFeatureWidth;
        new_height = pluginData.smallFeatureHeight;
        new_top = 54;//options.smallFeatureOffset + options.topPadding;
        new_zindex = 1;
        new_fade = 0.4;
    ...
    var move = function(direction)
    {
      ...
      if (direction == true) {
		...
		$newLeft.addClass("featureRightLeft");
		$newRight.addClass("featureRightLeft");
      }
      ...
      $newCenter.removeClass("featureRightLeft");
      //$newCenter.addClass("featureClassCenter");
